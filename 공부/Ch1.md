...
* 주로 JSON 형식 제공
* 다양한 시스템에서 호출
* 데이터만 주고 받음 ,UI 화면이 필요하면,클라리언트가 별도 처리


![스크린샷 2024-03-01 오후 2 17 28](https://github.com/pbk2312/SpringMVC_1/assets/156402683/15193b81-9acd-41de-ac85-be552e36828e)
...
* HTML 만드는 것을 서버에서 다 끝내고 웹 브라우저는 단순하게 생성된 것을 보여줌
![스크린샷 2024-03-01 오후 2 22 39](https://github.com/pbk2312/SpringMVC_1/assets/156402683/a46a1aa4-c40f-41ee-8f0c-e4de18a49cad)
...
* CSR - 클라이언트 사이드 렌더링
  ...
  * 에)구글 지도,Gmail,구글 캘린더
  * 관련기술:React,Vue.is -> 웹 프론트엔드 개발자

  

![스크린샷 2024-03-01 오후 2 23 43](https://github.com/pbk2312/SpringMVC_1/assets/156402683/8afedb5b-fd6d-4379-80cd-db0393ea945b)
